...
netconf.u_netconfs[0].unet_downsampling_strategy = [[1,2,2],[1,2,2],[1,2,2],[1,2,2]]
netconf.u_netconfs[0].unet_conv_down = [[[1,3,3],[1,3,3]]]
netconf.u_netconfs[0].unet_conv_up = [[[1,3,3],[1,3,3]],[[1,3,3],[1,3,3]],[[1,3,3],[1,3,3]],[[1,3,3],[3,3,3]]]
...
inshape,outshape,fmaps = pygt.netgen.compute_valid_io_shapes(netconf,pygt.netgen.caffe_pb2.TRAIN,[3,400,400],[3,500,500],constraints=[None, None, lambda x: x[1]])
